...
export const FaqSection: React.FC = () => {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: 'تُخزن سجلات المتابعة محلياً في متصفحك، ولا توجد مزامنة حسابات تلقائية بين الأجهزة. يمكنك تصدير نسخة من الإعدادات والعدادات والسجلات بصيغة JSON من شاشة الإعدادات، ثم استعادتها على جهاز آخر. احتفظ بنسخة آمنة قبل مسح بيانات الموقع أو تغيير الهاتف.',
    },
    {
      question: 'كيف أستخدم قضاء على آيفون أو أندرويد؟',
      answer: 'افتح رابط قضاء في متصفح هاتفك واضغط «افتح التطبيق». لا تحتاج إلى تثبيت أو حساب أو إعدادات خاصة بالهاتف.',
    },
    {
      question: 'هل يعمل التطبيق بدون اتصال بالإنترنت؟',
      answer: 'تحتاج الزيارة الأولى إلى الإنترنت، ويجهّز قضاء الملفات تلقائياً أثناء استخدامك له. بعد ظهور رسالة «جاهز بدون إنترنت» يمكنك فتح الرابط نفسه في المتصفح نفسه لتسجيل الصلوات والصيام والأذكار وقراءة القرآن دون اتصال. تلاوة الصوت وتحميل تفسير جديد يحتاجان إلى الإنترنت. يعتمد العمل دون اتصال على احتفاظ المتصفح بملفات الموقع؛ إذا مُسحت هذه الملفات فستحتاج إلى فتحه بالإنترنت مرة أخرى.',
    },
    {
      question: 'هل تطبيق قضاء مجاني؟ وهل يحتوي على إعلانات؟',
      answer: 'وظائف المتابعة الأساسية مجانية. قد تُعرض إعلانات في مقالات دليل الاستخدام بعد تفعيل الخدمة والموافقة عليها، وليس داخل شاشة القرآن أو عدادات المتابعة. لا نستخدم سجل صلواتك لتخصيص الإعلانات. يمكنك معرفة التفاصيل وخياراتك من صفحة الخصوصية والإعلانات.',
    },
    {
